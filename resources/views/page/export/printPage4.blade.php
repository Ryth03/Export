    ...
    <section class="print-page">
        <main class="content main-background">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="">
                    PL/<span>{{ str_replace('ESM', '', $exportDoc['so_nbr'] ?? '') }}</span>/{{ date('m', strtotime($exportDoc['created_at'] ?? now())) }}/{{ date('Y', strtotime($exportDoc['created_at'] ?? now())) }}
                </div>
                <div class="text-sm">
                    <div>
                        <p>This is the packing list for your shipment.</p>
                    </div>
                    <div>
                        <table id="packingTable" class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4"></td>
                                    <td colspan="2">{{ number_format($chunk->sum('net_weight'), 2, ',', '.') }}</td>
                                    <td colspan="2">{{ number_format($chunk->sum('gross_weight'), 2, ',', '.') }}</td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <p>BATCH NO.:</p>
                                        <p>{{ $exportDoc['batch_no'] ?? '' }}</p>
                                    </td>
                                    <td colspan="4"></td>
                                </tr>
                                <tr>
